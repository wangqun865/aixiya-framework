...
import com.aixiya.framework.backend.common.constant.PageConstant;
import com.aixiya.framework.backend.common.constant.RegexpConstant;
import com.aixiya.framework.backend.common.constant.StringConstant;
...
public class AixiyaFwUtil {
    ...
    public static String getCurrentUsername() {
        ...
        if (principal instanceof AixiyaFwAuthUser) {
            return ((AixiyaFwAuthUser) principal).getUsername();
        }
