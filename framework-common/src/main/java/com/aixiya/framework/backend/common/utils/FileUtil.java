...
public class FileUtil {
    ...
    public static void download(String filePath, String fileName, Boolean delete, HttpServletResponse response) throws Exception {
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment;fileName=" + java.net.URLEncoder.encode(fileName, AixiyaFwConstant.UTF8));
        response.setContentType(MediaType.MULTIPART_FORM_DATA_VALUE);
        response.setCharacterEncoding(AixiyaFwConstant.UTF8);
    ...
    private static Boolean fileTypeIsValid(String fileType) {
        ...
        return ArrayUtils.contains(AixiyaFwConstant.VALID_FILE_TYPE, fileType);
    }
