...
import com.aixiya.framework.backend.common.entity.QueryRequest;
...
public class SortUtil {
    ...
    public static void handlePageSort(QueryRequest request, Page<?> page, String defaultSort, String defaultOrder, boolean camelToUnderscore) {
        ...
        if (camelToUnderscore) {
            sortField = AixiyaFwUtil.camelToUnderscore(sortField);
            defaultSort = AixiyaFwUtil.camelToUnderscore(defaultSort);
        }
        if (StringUtils.isNotBlank(request.getField())
            ...
            if (StringUtils.equals(request.getOrder(), AixiyaFwConstant.ORDER_DESC)) {
            ...
            if (StringUtils.isNotBlank(defaultSort)) {
                if (StringUtils.equals(defaultOrder, AixiyaFwConstant.ORDER_DESC)) {
